...
dimx=size(x,2);
dimy=size(y,2);
% gaussian variance, complex order filter
varianza=sqrt(55);
ordine=1;
gamma=2;
...
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
if 1==0%------------------------------- ----------------------> old algorithm which dates Gaussian pyramid
    %-------------------------------------
    ...
    %-------------------------------------
    %-----------------------------------------> z z1 z2 z3 -----------------------
    % now have the various complex field for different levels of blur -----------------------
    %-------------------------------------------------------------------
    ...
    % other processing ----------------
    %------------------------------------
    % work with temp0 temp1 temp2 temp3
    %------------------------------------
